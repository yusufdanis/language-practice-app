...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart, language }) => {
  const practiceLabel = language === 'en' ? 'English (April 2025)' : language === 'en_words' ? 'English (February 2026)' : language === 'en_march_2026' ? 'English (March 2026)' : language === 'de_march_2026' ? 'German (March 2026 - DE→TR)' : language === 'de_march_2026_tr' ? 'German (March 2026 - TR→DE)' : 'German';
